###########################################################################
## This script generates the dataset for the ICN2 pocketbook 2014
###########################################################################
...
Sourcehttps("https://raw.githubusercontent.com/filippogheri/ComplementaryScripts/master/CheckLogical.R",
            "https://raw.githubusercontent.com/filippogheri/ComplementaryScripts/master/ReadConstruction.R",
            "https://raw.githubusercontent.com/filippogheri/ComplementaryScripts/master/ReadMetadata.R",
            "https://raw.githubusercontent.com/filippogheri/ComplementaryScripts/master/sum2.R",
            "https://raw.githubusercontent.com/filippogheri/ComplementaryScripts/master/CheckValues.R")
source("./Rcode/Final/CarryBackward.R")
source("./Rcode/Final/CarryForward.R")
source("./Rcode/Final/MovingAverage.R")
source("./Rcode/Final/ReplaceValue.R")
source("./Rcode/Final/SetToNa.R")
...
con.df <- ReadConstruction(file = "./Data/Processed/Construction.csv", 
                           encoding = "UTF-8", nrows = 220)
meta.lst <- ReadMetadata(file = "./Data/Processed/Metadata.csv", 
                         encoding = "UTF-8", nrows = 220)
