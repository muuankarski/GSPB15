...
chart_spread2(title="Labour",                
            ...
            notes="Maps should have average from last five years, but currently only showing the latest. Applies to all maps"
            )         
@
...
chart_spread2(title="Food supply",
            ...
            BottomChartCode="issues", 
            MapCode="issues",
            notes="Issues relate to different regional aggregation used in FSI indicators (SOFI)"
            )
@
