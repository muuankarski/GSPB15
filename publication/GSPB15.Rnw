...
\thispagestyle{empty}
\ifprint
\includepdf[width=\paperwidth,height=\paperheight, offset=10 -70]{./I4691E_disclaimer.pdf}
\else
\includepdf[width=\paperwidth,height=\paperheight, offset=10 -30]{./I4691E_disclaimer.pdf}
\fi
...
% \IfFileExists{./Plots/C.P1.OVER.1.5.pdf}{\includegraphics[width = 8cm, height = 4.5cm]{{./Plots/C.P1.OVER.1.5}.pdf}}{} 
% \end{chart}} 
...
chart_spread2(title="Economic and political stability",                
