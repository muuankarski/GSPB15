...
chart_spread2(title="Overview",                
            ...
            notes="Data Updated. Ready for writing!")
@
...
=======
            LeftTextCode="A strong labour market is the foundation for sustained well-being and economic growth, inclusion and social cohesion. Therefore access to safe, productive and remunerated work is essential. Yet many workers, especially the most vulnerable, do not enter into formal wage employment but are instead self-employed or participate in unpaid family work, such as in agriculture. This is especially the case with subsistence farming. As a large share of the working poor are involved in agriculture, developments in this sector have a major impact on welfare.", 
>>>>>>> 5e32d6d73cd190708bb69f5920d83a6f590bde5f
            ...
            #notes="BOTTOM CHART CHILD EMPLOYMENT ONLY FEW COUNTRIES HOW TO DISPLAY!! Maps should have average from last five years, but currently only showing the latest. Applies to all maps"
            )         
@
...
chart_spread2(title="Inputs",
            ...
            notes="Maps issues remains. Now we have same indicators for each of the charts - Nitrogen and Phosphate in the top-bottom charts??"
            )         
@
...
chart_spread2(title="Investment",                
            ...
            notes="Each of the proposed indicator missing from the SYB DB. Need to think about replacements or way to include them. Maps issues remains."
            )         
@
...
chart_spread2(title="Food Availability",                
            LeftTextCode="Text comes here",  
            RightTextCode="issues",   
            LeftChartCode="C.P2.AV.1.3",   
            RightChartCode="C.P2.AV.1.4",  
            BottomChartCode="C.P2.AV.1.5", 
            MapCode="M.P2.AV.1.6",
            notes="Indicator: Average dietary energy supply adequacy, 3 year averages: is manually created. have to find the script if this needs to be reproduced." 
            )
@
...
chart_spread2(title="Access",                
            ...
            notes="Both <Prevalence of undernourishment, 3 year averages> AND <Prevalence of food inadequacy, 3 year averages> Should we think of other ways to "
            )
@
...
chart_spread2(title="Stability",                
            ...
            notes="Should we put something for the top right corner??"
            )
@
...
chart_spread2(title="Utilization",                
            ...
            MapCode="M.P2.UT.1.6",
            notes="VAR <Percentage of children under 5 years of age who are underweight> is not used, though EXISTS. <Access to improved sanitation facilities> does not exists in the database"
            )
@
%
%                         .^^^\ ../~/\       .==...==.
...
chart_spread2(title="Food supply",
            LeftTextCode="",  
            RightTextCode="issues",   
            LeftChartCode="C.P3.SUP.1.3",   
            RightChartCode="C.P3.SUP.1.4",  
            BottomChartCode="C.P3.SUP.1.5", 
            MapCode="M.P3.SUP.1.6",
            notes="<Protein and fat supply in crops primary equivalent (2000-09), world> for the top right"
            )
@
...
chart_spread(title="Growth in crop production",
            ...
            notes="ISSUES is with the `2. Chart: fastest growing items between 2000-MRY` - from where and how to get that data"
            )
@
...
chart_spread(title="Trends in the crop sector",                
            ...
            notes="What type of chart was planned for this:  (Chart: top five items produced in MRY vs. 2000)"
            )
@
...
chart_spread2(title="Trends in the livestock sector",
            ...
            notes="ISSUES: custom charts from SYB13 cannot be reproduced as the scripts are missing... Also, there are no per capita figures available (should be computed. Pie charts are not available in the SYB system)"
            )
@
...
chart_spread2(title="Trends in the fisheries sector",
            ...
            notes="FOR BOTTOM PLOT State of the world’s fishery stocks (see chart 79 in SYB2013) HAVE TO BE SCRAPED FOR DATA"
            )
@
...
chart_spread2(title="Water",                
            ...
            notes="There are some issues with the water data as can be seen from each of the graphs. SALINE SOILS for the bottom chart has not been defined in metadata. Any leads welcome"
            )
@
...
chart_spread2(title="Forestry",                
            ...
            notes="Forest characteristics NOT YET SCRAPED FROM FRA REPORT"
            )
@
