...
chart_spread2(title="Labour",                
            LeftTextCode="In developing regions, employment growth is driven mostly by demographic changes. Many workers do not enter into formal wage employment but are instead self-employed or participate in unpaid family work, such as in agriculture, especially subsistence farming. As a large share of the working poor are involved in agriculture, developments in this sector have a major impact on welfare. Nearly eight out of ten working poor with less than US\\$1.25/day live in rural areas. This means that most jobs in rural areas do not ensure sufficient levels of income for workers to afford adequate food for themselves and their families.",  
