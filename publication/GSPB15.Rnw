...
chart_spread2(title="Land",                
            LeftTextCode="More than 1.5 billion hectares – about 12 percent of the world’s land area – are used for crop production (arable land plus land under permanent crops). Although large amounts of land are potentially suitable for agriculture, much of this land is covered by forests, protected for environmental reasons or are cities. Potentially accessible agricultural land is very unevenly distributed among regions and countries. Some 90 percent is
in Latin America and sub-Saharan Africa. At the other extreme, there is virtually no spare land available for agricultural expansion in Southern Asia, the Western Asia and Northern
Africa.",  
