...
%   	\LeftText{\IfFileExists{./Text/TXT.P1.ECON.1.1.tex}{\input{./Text/TXT.P1.ECON.1.1.tex}}{\lipsum[2]}}

% 	\RightText{\begin{chart}
% 		\input{./Captions/Caption_C.P1.ECON.1.2.tex}
%         		\IfFileExists{./Plots/C.P1.ECON.1.2.pdf}{\includegraphics[width = 4cm, height = 3cm]{{./Plots/C.P1.ECON.1.2}.pdf}}{}
% 		\end{chart}}

% 	\LeftChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.ECON.1.3.tex}
% 		\vspace{-7pt}
%         		\IfFileExists{./Plots/C.P1.ECON.1.3.pdf}{\includegraphics[width = 4cm, height = 8cm]{{./Plots/C.P1.ECON.1.3}.pdf}}{}
% 	\end{chart}} 

% 	\RightChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.ECON.1.4.tex}
%         		\IfFileExists{./Plots/C.P1.ECON.1.4.pdf}{\includegraphics[width = 4cm, height = 8cm]{{./Plots/C.P1.ECON.1.4}.pdf}}{}
% 	\end{chart}} 

% 	\BottomChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.ECON.1.5.tex}
% 		\IfFileExists{./Plots/C.P1.ECON.1.5.pdf}{\includegraphics[width = 8cm, height = 3cm]	{{./Plots/C.P1.ECON.1.5}.pdf}}{}
% 	\end{chart}}

\end{ChartPage}

% \begin{figure}
% 	\input{./Captions/Caption_M.P1.ECON.1.6.tex}
%         		\IfFileExists{./Maps/M.P1.ECON.1.6.pdf}{\centering\includegraphics[height = 1\columnwidth, angle=90]{{./Maps/M.P1.ECON.1.6}.pdf}\par}{\newpage\thispagestyle{empty}\mbox{}}{}
% \end{figure}
...
%   	\LeftText{\IfFileExists{./Text/TXT.P1.OVER.1.1.tex}{\input{./Text/TXT.P1.OVER.1.1.tex}}{\lipsum[2]}}
...
%         		\IfFileExists{./Plots/C.P1.OVER.1.3.pdf}{\includegraphics[width = 4cm, height = 8cm]{{./Plots/C.P1.OVER.1.3}.pdf}}{}
% 	\end{chart}} 

% 	\RightChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.OVER.1.4.tex}
% 		\vspace{-7pt}
%         		\IfFileExists{./Plots/C.P1.OVER.1.4.pdf}{\includegraphics[width = 4cm, height = 8cm]{{./Plots/C.P1.OVER.1.4}.pdf}}{}
% 	\end{chart}} 

% 	\BottomChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.OVER.1.5.tex}
% 		\IfFileExists{./Plots/C.P1.OVER.1.5.pdf}{\includegraphics[width = 8cm, height = 3cm]	{{./Plots/C.P1.OVER.1.5}.pdf}}{}
% 	\end{chart}}
...
% 			\input{./Plots/MT.P1.IAF.1.2.tex}
% 		\end{table}}}

% 	\LeftChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.IAF.1.3.tex}
% 		\vspace{-7pt}
%         		\IfFileExists{./Plots/C.P1.IAF.1.3.pdf}{\includegraphics[width = 4cm, height = 8cm]{{./Plots/C.P1.IAF.1.3}.pdf}}{}
% 	\end{chart}} 

% 	\RightChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.IAF.1.4.tex}
% 		\vspace{-7pt}
%         		\IfFileExists{./Plots/C.P1.IAF.1.4.pdf}{\includegraphics[width = 4cm, height = 8cm]{{./Plots/C.P1.IAF.1.4}.pdf}}{}
% 	\end{chart}} 

% 	\BottomChart{\begin{chart}
% 		\input{./Captions/Caption_C.P1.IAF.1.5.tex}
% 		\IfFileExists{./Plots/C.P1.IAF.1.5.pdf}{\includegraphics[width = 8cm, height = 3cm]	{{./Plots/C.P1.IAF.1.5}.pdf}}{}
% 	\end{chart}}
