...
<<spread_function, eval=FALSE, echo=FALSE>>=
...
<<economy, eval=FALSE>>=
chart_spread(title="Economy",                # Amy you could specify here
...
<<prices, eval=FALSE>>=
chart_spread(title="Prices",
            LeftTextCode="P1.OVER.1.1",
            RightTextCode="MT.P1.OVER.1.2",
            footnoteRight="Data after 2010 are projections.",
            LeftChartCode="C.P1.OVER.1.2",
            RightChartCode="C.P1.OVER.1.3",
            BottomChartCode="C.P1.OVER.1.4",
