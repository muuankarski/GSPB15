...
#             \\input{./Captions/Caption_",LeftChartCode,".tex} \n",
	...
	cat(paste0("\\RightChart{\\begin{chart} \n
              {\\renewcommand\\normalsize{\\fontsize{6.6}{7}}%
              \\normalsize\\input{./Captions/Caption_",RightChartCode,".tex}} \n",
	                footnoteRightText,
  ...
  "{\\renewcommand\\normalsize{\\fontsize{6.6}{7}}% \n",
   "\\normalsize\\input{./Captions/Caption_",MapCode,".tex}} \n",
...
chart_spread2 <- function(title="title",
  ...
  if (exists("footnoteRight")) footnoteRightText <- paste0("\\small{",footnoteRight,"}  \n")
  if (!exists("footnoteRight")) footnoteRightText <- "\\vspace{-7pt} \n"
